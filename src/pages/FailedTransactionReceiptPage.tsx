...
const FailedTransactionReceiptPage = () => {
  ...
  const handleDownloadReceipt = async () => {
    try {
      ...
      details.forEach((detail) => {
        ...
        ctx.fillStyle = detail.label === 'Status:' ? '#dc2626' : '#000000';
      ...
      canvas.toBlob((blob) => {
        ...
        link.href = url;
        link.download = `failed-receipt-${transaction?.order_id || Date.now()}.png`;
        ...
        toast({
          ...
          description: "Failed transaction receipt saved successfully to your device",
        });
      }, 'image/png');
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <header className="flex items-center justify-between p-4 bg-background">
        ...
        <h1 className="text-lg font-semibold text-foreground">Failed Transaction Receipt</h1>
        <div className="w-10" />
      </header>
      ...
      <div className="p-4">
        ...
        <div className="bg-white rounded-lg shadow-lg p-6 mx-auto max-w-sm">
          {/* Header with Failed Icon */}
          <div className="text-center mb-6">
            <div className="flex justify-center mb-4">
              <XCircle className="w-16 h-16 text-red-600" />
            </div>
            <h2 className="text-xl font-bold text-foreground mb-2">AMAKSUB DATA</h2>
            <p className="text-sm text-muted-foreground">Failed Transaction Receipt</p>
...
export default FailedTransactionReceiptPage;