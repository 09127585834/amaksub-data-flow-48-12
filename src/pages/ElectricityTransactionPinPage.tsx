...
const ElectricityTransactionPinPage = () => {
  ...
  const processTransaction = async () => {
    ...
    try {
      ...
      // Call GSUBZ electricity API
      const { data, error } = await supabase.functions.invoke('gsubz-electricity', {
        body: {
          disco_name: selectedBillerCode,
      ...
      if (error || !data?.success) {
        console.error('Error calling electricity function:', error || data);
      ...
      if (data.success) {
        ...
        navigate('/purchase-success', {
          state: {
            ...
            customerName: data.transaction?.customer_name || customerName,
            selectedBiller: selectedBiller,
            phoneNumber: phoneNumber,
            orderId: data.transaction?.id,
            newBalance: data.transaction?.balance,
...
export default ElectricityTransactionPinPage;